...
class Finger_detector:
    ...
    def _fingerStraight(self, x1:int,x2:int,y1:int,y2:int,tx:int,ty:int) -> bool:
        """
        ...
        tip = self._isInside(x,y,rad,x2,y2)
    ...
    def _detect_pinch(self, x1:int,y1:int,x2:int,y2:int,x3:int,y3:int, index:bool, thumb:bool) -> bool:
        """
    ...
    def _middle(self,x1:int,x2:int,y1:int,y2:int) -> tuple:
    ...
    def _isInside(self,circle_x:int, circle_y:int, rad:int, x:int, y:int) -> bool:
    ...
    def _dist_2_points(self,x1:int, x2:int, y1:int, y2:int) -> int:
